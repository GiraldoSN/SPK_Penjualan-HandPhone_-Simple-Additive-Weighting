                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <button type="button" class="btn btn-outline-success btn-sm m-6" data-bs-toggle="modal" data-bs-target="#inlineForm">
                                    Tambah Alternatif
                                </button>
                                <hr>
                                <div class="table-responsive">
                                    <table class="table table-striped mb-0">
                                        <caption>Tabel Alternatif<sub>i</sub></caption>
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nama</th>
                ...
                <form action="alternatif-simpan.php" method="POST">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan Nama Kandidat..." required>
                        </div>
                    </div>

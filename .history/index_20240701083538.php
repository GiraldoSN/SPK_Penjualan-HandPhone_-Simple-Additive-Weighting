...
<body>
    <div id="app" style="background-color: #f4f4f9;">
        ...
        <div id="main">
            <header class="mb-3" style="background-color: #3a3f44; color: white; padding: 0px;">
                <a href="#" class="burger-btn d-block d-xl-none">
                    <i class="bi bi-justify fs-3"></i>
                </a>
            </header>
            <div class="page-heading" style="padding: 20px; animation: fadeInUp 1s ease;">
                <h3 style="text-align:center; margin-bottom: 10px;">Dashboard</h3>
                <p style="text-align: center; color: #666; font-size: 16px;">Sistem Pendukung Keputusan Manajer IT Terbaik</p>
            </div>
            <div class="page-content" style="padding: 20px; animation: slideInLeft 1s ease;">
                <section class="row">
                    <div class="col-12">
                        <div class="card" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                            <div class="card-header" style="background-color: #96C9F4; color: white; border-radius: 10px 10px 0 0; animation: fadeIn 1s ease;">
                                <h4 style="margin: 0;">Simple Additive Weighting (SAW)</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body" style="padding: 20px; animation: fadeIn 1s ease;">
